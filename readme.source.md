...
<div style={{ position: 'relative', display: 'flex', width: '100%', height: '100%', background: '#1be4ff52', borderRadius: 20, boxSizing: 'border-box', overflow: "hidden", boxShadow: 'inset 0 5px 15px 0 rgba(255,255,255,0.4), inset 0 -5px 15px 0 rgba(255,255,255,0.15), inset 5px 0 15px 0 rgba(255,255,255,0.2), inset -5px 0 15px 0 rgba(255,255,255,0.2)' }}>
